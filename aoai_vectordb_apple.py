...
print(f"문장 임베딩: CLS 토큰 임베딩 (총 {len(sentence_emb_1)}차원): {short_embed(sentence_emb_1)}")
print(f"apple 임베딩 (총 {len(apple_emb_1)}차원): {short_embed(apple_emb_1)}")

print("\nSentence 2\n------------------------")
print(f"Sentence: {sentence2}")
print(f"Token: {tokens_2}")
print(f"문장 임베딩: CLS 토큰 임베딩 (총 {len(sentence_emb_2)}차원): {short_embed(sentence_emb_2)}")
